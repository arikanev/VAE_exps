...
torchvision.utils.save_image(N_to_save.data.cpu(), '../data/main_rfw/input_noise_rfw.png')
target_to_save = targets[0].view(targets[0].size(0), 1, 28, 28)
torchvision.utils.save_image(target_to_save.data.cpu(), '../data/main_rfw/target_rfw.png')
...
for iter in range(10000):
        ...
        if iter % 100 == 0:
            ...
            torchvision.utils.save_image(out_to_save.data.cpu(), '../data/main_rfw/out_iter_rfw%d.png' % (iter + 1))
